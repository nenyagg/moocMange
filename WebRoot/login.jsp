...
<head>
	...
	<meta name="description" content="login and sign up" />
...
<br />
<h1>注册登录<sup>V.test</sup></h1>

<div class="login" style="margin-top:50px;">
    
    <div class="header">
        <div class="switch" id="switch"><a class="switch_btn_focus" id="switch_qlogin" href="javascript:void(0);" tabindex="7">快速登录</a>
			<a class="switch_btn" id="switch_login" href="javascript:void(0);" tabindex="6">快速注册</a><div class="switch_bottom" id="switch_bottom" style="position: absolute; width: 64px; left: 10px;"></div>
        </div>
    </div>    
    ...
    <div class="web_qr_login" id="web_qr_login" style="display: block; height: 235px;">    
			...
			<div class="login_form">
               ...
               <input type="hidden" name="to" value="log"/>
                ...
                <div class="pwdArea" id="pass">
               <label class="input-tips" for="p">密码: </label> 
               <div class="inputOuter" id="pArea">
                    
                    <input type="password" id="p" name="passowrd" class="inputstyle"/>
                </div>
                </div>
               
                <div style="padding-left:50px;margin-top:20px;"><input type="submit" value="登录" style="width:150px;" class="button_blue"/></div>
              </form>
           </div>
    ...
    <div class="qlogin" id="qlogin" style="display: none; ">
	    ...
	    <div class="web_login"><form name="form2" id="regUser" accept-charset="utf-8"  action="register.action" method="post" >
	        ...
	        <ul class="reg_form" id="reg-ul" >
	        		<div id="userCue" class="cue" >注册注意格式 </div>
	                <li>
	                ...
	                <label for="passwd2" class="input-tips2">确认密码:  </label>
	                 ...
	                 <li>
	                <label for="usermail" class="input-tips2">Email:  </label>
	                    <div class="inputOuter2">
	                ...
	                <li>
	                    <div class="inputArea">
	                        <input type="button" id="reg"  style="margin-top:10px;margin-left:40px;" class="button_blue" 
